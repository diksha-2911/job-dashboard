...
export const Navbar = ()=>{
    ...
    return(
        ...
        <div className="flex z-50 bg-slate-50 border-b-2 fixed top-0 items-center w-full py-6 px-8 text-black">
            <div className="justify-center items-center font-semibold text-base text-[#dc4a2d] py-2 px-3 bg-[#e7e7e7]">Logo</div>
        ...
        <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-gray-400	flex flex-wrap items-center text-base justify-center">
            <button className="mr-8 pb-2 hover:text-[#dc4a2d] hover:border-b-2 hover:border-[#dc4a2d]">Job Preview</button>
            <button className="mr-8 pb-2 hover:text-[#dc4a2d] hover:border-b-2 hover:border-[#dc4a2d]">Applicants</button>
            <button className="mr-8 pb-2 hover:text-[#dc4a2d] hover:border-b-2 hover:border-[#dc4a2d]">Match</button>
            <button className="mr-8 pb-2 hover:text-[#dc4a2d] hover:border-b-2 hover:border-[#dc4a2d]">Messages</button>
        </nav>
         </div>
