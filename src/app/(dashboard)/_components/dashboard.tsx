...
export const Dashboard = ()=>{
    ...
    <div className="flex items-center justify-start pl-2">
      <h1 className="sm:text-3xl text-2xl font-semibold title-font mb-2 text-[#3d3d3d]">Senior Product Designer</h1>
      ...
      <div className="items-center gap-x-4 w-1/4">
       ...
       <Image 
                    ...
                    <button className="py-1 px-2 text-[#003788] bg-[#E0EBF9] shadow-md shadow-gray-400 rounded-md text-xs font-bold">Follow</button></div>
        ...
        <button className="pt-6 text-xs underline px-4 text-[#b0b0b0] hover:text-gray-800">Report this listing</button>
    </div>

    <div className="md:w-1/4 md:pl-8">
        <div className="flex justify-center gap-x-6 pt-6">
        <button className="items-center justify-center inline-flex text-sm text-[#dc4a2d] px-2 w-1/2 py-2 border-2 border-[#dc4a2d] bg-[#FEF4F2] rounded-md"><Image 
                    src = "/Icon (6).svg" 
      ...
      <ul className="flex flex-wrap -mb-1">
        ...
        <li className="py-6 mb-1 w-full border-b-2">
          ...
          <a className="flex text-gray-600 hover:text-gray-800"><Image 
                    src = "/Icon (8).svg" 
                    ...
                    alt = "reading"
                    />Applications
                    <h2 className="ml-auto text-right justify-between">400</h2></a>
            </li>
        ...
        <li className="py-6 mb-1 w-full border-b-2">
          <a className="flex text-gray-600 hover:text-gray-800"><Image 
                    ...
                    height={16}
                    alt = "reading"/>
                    Matches<h2 className="ml-auto text-right justify-between">100</h2></a>
        </li>
        <li className="py-6 mb-1 w-full border-b-2">
          <a className="flex text-gray-600 hover:text-gray-800"><Image 
                    src = "/Icon (10).svg" 
                    ...
                    width={16}
                    height={16}
                    alt = "reading"/>Messages<h2 className="ml-auto text-right justify-between">147</h2></a>
        </li>
        <li className="py-6 mb-1 w-full">
          <a className="flex text-gray-600 hover:text-gray-800"><Image 
                    ...
                    width={16}
                    height={16}
                    alt = "reading"/>Views<h2 className="ml-auto text-right justify-between">800</h2></a>
        </li>
      
      </ul>

      <div className="p-4 mx-auto mt-4 w-full border-gray-900 shadow-xl rounded-lg">
      <h2 className="mb-4 font-extrabold text-lg text-black">"A quote from Atlassian"</h2>
        <div className="h-full flex items-center py-4 px-2">  
          ...
          <Image 
                    ...
                    width={40}
                    height={40}
                    alt = "reading"/><h2 className="ml-auto text-right justify-between"></h2>
